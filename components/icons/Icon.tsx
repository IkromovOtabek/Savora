...
const PATHS: Record<IconName, ReactNode> = {
  logo: <><path d="M6 20 L12 6" /><path d="M12 6 L18 20" /></>,
  home: <><path d="M3 9.5 12 3l9 6.5V20a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1z" /><path d="M9 21V12h6v9" /></>,
  building: <><rect x="4" y="2" width="16" height="20" rx="2" /><path d="M9 22v-4h6v4M8 6h.01M12 6h.01M16 6h.01M8 10h.01M12 10h.01M16 10h.01M8 14h.01M12 14h.01M16 14h.01" /></>,
  plans: <><rect x="2" y="5" width="20" height="14" rx="2" /><line x1="2" y1="10" x2="22" y2="10" /><path d="M6 15h2M10 15h4" /></>,
  ...
  signup: <><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2" /><circle cx="8.5" cy="7" r="4" /><line x1="20" y1="8" x2="20" y2="14" /><line x1="23" y1="11" x2="17" y2="11" /></>,
  ...
  utensils: <><path d="M3 2v7c0 1.1.9 2 2 2h0a2 2 0 0 0 2-2V2" /><path d="M7 2v20" /><path d="M21 15V2a5 5 0 0 0-5 5v6c0 1.1.9 2 2 2h3v6" /></>,
...
export function IconBadge({ name, bg, className = '' }: { name: IconName; bg?: string; className?: string }) {
  return (
    <span className={`icon-badge ${className}`.trim()} style={bg ? { background: bg } : undefined}>
      <Icon name={name} size={18} strokeWidth={2.5} />
    </span>
  );
}
